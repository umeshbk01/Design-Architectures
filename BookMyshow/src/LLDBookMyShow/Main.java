...
import LLDBookMyShow.Constants.SeatCategory;
import LLDBookMyShow.Controller.MovieController;
import LLDBookMyShow.Controller.TheathreController;
...
public class Main {MovieController movieController;
    TheathreController theatreController;

    Main() {
        movieController = new MovieController();
        theatreController = new TheathreController();
    }
    ...
    private void createBooking(City userCity, String movieName) {
        ...
        Map<Theathre, List<Show>> showsTheatreWise = theatreController.getAllShow(interestedMovie, userCity);

        //4. select the particular show user is interested in
        Map.Entry<Theathre,List<Show>> entry = showsTheatreWise.entrySet().iterator().next();
    ...
    private void createTheatre() {
        ...
        Theathre inoxTheatre = new Theathre();
        ...
        Theathre pvrTheatre = new Theathre();
        ...
        theatreController.addTheathre(inoxTheatre, City.Bengaluru);
        theatreController.addTheathre(pvrTheatre, City.Delhi);
    ...
    private void createMovies() {
        ...
        movieController.addMovie(baahubali, City.Bengaluru);
