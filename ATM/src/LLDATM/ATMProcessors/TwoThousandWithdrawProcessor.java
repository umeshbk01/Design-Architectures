...
public class TwoThousandWithdrawProcessor extends CashWithdrawProcess{
    public TwoThousandWithdrawProcessor(CashWithdrawProcess nextCashWithdrawProcessor) {
