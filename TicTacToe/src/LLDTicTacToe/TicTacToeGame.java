...
import LLDTicTacToe.Modal.Player;
...
public class TicTacToeGame {
    ...
    public String startGame(){
        ...
        while(noWinner){
            ...
            //place the piece
            boolean pieceAddedSuccessfully = gameBoard.addPiece(inputRow,inputColumn, playerTurn.getPlayingPieces());
            ...
            boolean winner = isThereWinner(inputRow, inputColumn, playerTurn.getPlayingPieces().pieceType);
            if(winner) {
